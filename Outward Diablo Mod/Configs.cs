...
namespace grindward
{
    public class Configs
    {
        ...
        public ConfigEntry<bool> EnableAmbushPenalties = newBool(BALANCE_ENABLE_CATEGORY, "Enable Ambush Penalties", "Adds hunger, sleep and thirst penalty when ambushed. This is to prevent ambushes being a good way to farm mobs.");
