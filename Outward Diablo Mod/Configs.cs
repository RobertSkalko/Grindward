...
namespace grindward
{
    public class Configs
    {
        ...
        public ConfigEntry<bool> EnableStatCaps = newBool(BALANCE_ENABLE_CATEGORY, "Enable caps to stats like resistances and mana reduction, So you can't have 100% resistance for example.");
